    ...
    >
      <div className="space-y-6">
        ...
        <div className="relative p-[1px] rounded-2xl bg-gradient-to-r from-primary-500/50 via-accent-purple/50 to-accent-pink/50">
          <div className="text-center py-5 bg-white rounded-2xl">
        ...
        <div className="relative">
          ...
          {/* PayPal container - now blends with light theme */}
        ...
        <motion.div
          ...
          className="flex items-center justify-center gap-2 text-slate-500 text-xs px-4 text-center"
        >
          <CreditCard className="w-4 h-4 text-primary-500/60 flex-shrink-0" />
          <span>Credit/debit cards accepted via PayPal checkout</span>
        </motion.div>

        {/* Trust badges */}
        <div className="flex items-center justify-center gap-6 pt-4 border-t border-slate-200">
          <div className="flex items-center gap-2 text-slate-500 text-xs">
            <svg className="w-4 h-4 text-primary-500/60" fill="currentColor" viewBox="0 0 20 20">
